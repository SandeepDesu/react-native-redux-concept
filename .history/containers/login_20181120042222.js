...
class LoginComponent extends Component {
    ...
    submit = () => {
        if(this.props.userDetails && this.state.username === this.props.userDetails.username && this.state.password === this.props.userDetails.password){
            Actions.home();
        }else{
...
const mapDispatchToProps = (dispatch) => {
    return{
        ...
        updateUserDetails:(value)=>dispatch(updateUserDetails())
    }
}
